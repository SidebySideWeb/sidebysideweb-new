...
> = {
  el: {
    ...
    contactFormRecaptchaError: 'Η επαλήθευση ασφαλείας απέτυχε. Δοκιμάστε ξανά.',
    ...
    caseStudyReadMore: 'Διαβάστε το Case Study',
    ...
    stepLabel: 'Βήμα',
    notFoundTitle: 'Το Case Study δεν βρέθηκε',
    notFoundBody: 'Η σελίδα που ζητήσατε δεν υπάρχει ή έχει μετακινηθεί.',
    notFoundCta: 'Επιστροφή στα Case Studies',
  ...
  en: {
    ...
    contactFormRecaptchaError: 'Security verification failed. Please try again.',
