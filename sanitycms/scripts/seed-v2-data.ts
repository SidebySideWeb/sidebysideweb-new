...
export const contactPage = {
  ...
  budgetOptions: [
    {_type: 'formOption', value: '1', label: 'Μικρό / σύντομο'},
    {_type: 'formOption', value: '2', label: 'Μεσαίο έργο'},
    {_type: 'formOption', value: '3', label: 'Μεγάλο / πολυεπίπεδο'},
    {_type: 'formOption', value: '4', label: 'Ongoing / retainer'},
    {_type: 'formOption', value: '5', label: 'Δεν ξέρω ακόμα'},
  ],
